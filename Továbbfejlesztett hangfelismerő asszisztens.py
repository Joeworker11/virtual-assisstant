# -*- coding: utf-8 -*-
"""
Created on Wed Mar 31 22:48:34 2021
...
def greet():
    ...
    speak("Recon at your service Mr. Eckert, Please tell me how can i help you")
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('eckertjozsef5@gmail.com', '#######')
    server.sendmail('eckert_jozsef@hotmail.com', to, content)
    server.close()


def screenshot():
    img = pyautogui.screenshot()
    img.save("C:\\Program files\\Felhasználók\\József\\ss.png")
